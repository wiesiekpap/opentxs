...
namespace opentxs::blockchain::node::implementation
{
        ...
        auto FilterOracle::FilterDownloader::NextBatch() noexcept -> BatchType { return allocate_batch(type_); }
    ...
    FilterOracle::FilterDownloader::FilterDownloader(
       ...
       FilterOracle::FilterDownloader::~FilterDownloader()
        ...
        auto FilterOracle::FilterDownloader::batch_size(std::size_t in) noexcept -> std::size_t
        {
            if (in < 10) {
        ...
        auto FilterOracle::FilterDownloader::check_task(TaskType&) const noexcept -> void {}
        auto FilterOracle::FilterDownloader::trigger_state_machine() const noexcept -> void { trigger(); }
        auto FilterOracle::FilterDownloader::update_tip(const Position& position, const cfilter::Header&)
        const noexcept -> void
        {
        ...
        auto FilterOracle::FilterDownloader::process_reset(const zmq::Message& in) noexcept -> void
        {
        ...
        auto FilterOracle::FilterDownloader::queue_processing(DownloadedData&& data) noexcept -> void
        {
