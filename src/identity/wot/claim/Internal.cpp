...
using UnitTypeMap =
    robin_hood::unordered_flat_map<core::UnitType, claim::ClaimType>;
using UnitTypeReverseMap =
    robin_hood::unordered_flat_map<claim::ClaimType, core::UnitType>;
...
namespace opentxs
{
auto ClaimToUnit(const identity::wot::claim::ClaimType in) noexcept
    -> core::UnitType
{
...
auto UnitToClaim(const core::UnitType in) noexcept
    -> identity::wot::claim::ClaimType
{
    try {
