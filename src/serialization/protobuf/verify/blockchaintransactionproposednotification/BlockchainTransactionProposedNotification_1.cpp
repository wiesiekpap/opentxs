...
#include "internal/protobuf/verify/BlockchainTransactionProposedNotification.hpp"  // IWYU pragma: associated
...
#define PROTO_NAME "blockchain transaction proposed notification"
