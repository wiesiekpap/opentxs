    ...
    Item& responseBalanceItem)
{
    ...
    if (cheque.GetSenderNymID() != nymID) {
        LogOutput(OT_METHOD)(__func__)(
            ": Incorrect nym id (")(cheque.GetSenderNymID())(").")
            .Flush();
    ...
    if (cheque.GetAmount() != 0) {
        LogOutput(OT_METHOD)(__func__)(
            ": Invalid amount (")(cheque.GetAmount())(").")
            .Flush();
    ...
    if (false == context.VerifyIssuedNumber(cheque.GetTransactionNum())) {
        LogOutput(OT_METHOD)(__func__)(
            ": Invalid transaction number (")(cheque.GetTransactionNum())(").")
            .Flush();
    ...
    if (false == cheque.VerifySignature(context.RemoteNym())) {
        LogOutput(OT_METHOD)(__func__)(": Invalid cheque signature.").Flush();
    ...
    if (false == validBalance) {
        LogOutput(OT_METHOD)(__func__)(": Invalid balance statement.").Flush();
    ...
    LogDebug(OT_METHOD)(__func__)(
        ": Success cancelling cheque ")(cheque.GetTransactionNum())
        .Flush();
    ...
    if (cancelVoucher) {
    ...
    } else {
        {
            ...
            if (false == inboxLoaded) {
                LogOutput(OT_METHOD)(__func__)(": Failed to load sender inbox.")
                    .Flush();
    ...
    Item& responseBalanceItem)
{
    ...
    if (false == sameUnit) {
        LogOutput(OT_METHOD)(__func__)(": Deposit account unit definition "
    ...
    if (false == validNumber) {
        LogOutput(OT_METHOD)(__func__)(
            ": Invalid transaction number ")(chequeNumber)(".")
            .Flush();
    ...
    if (false == cheque.VerifySignature(senderContext.RemoteNym())) {
        LogOutput(OT_METHOD)(__func__)(": Invalid signature on cheque.")
            .Flush();
    ...
    if (false == validReceipient) {
        LogOutput(OT_METHOD)(__func__)(
            ": Nym ")(nymID)(" is not allowed to deposit this cheque.")
            .Flush();
    ...
    if (false == sourceAccount.Debit(amount)) {
        LogOutput(OT_METHOD)(__func__)(": Failed debiting source account.")
            .Flush();
    ...
    if (false == depositorAccount.Credit(amount)) {
        LogOutput(OT_METHOD)(__func__)(": Failed crediting depositor account.")
            .Flush();
    ...
    responseItem.SetStatus(Item::acknowledgement);
    success = true;
    LogDebug(OT_METHOD)(__func__)(": Success processing cheque ")(chequeNumber)
        .Flush();
}
    ...
    bool& bOutSuccess)
{
    ...
    if (false ==
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All "
    ...
    // So we treat it that way... I either get it successfully or not.
        ...
        auto strTemp = String::Factory(tranIn);
        LogOutput(OT_METHOD)(__func__)(": Failed attempt by user ")(
        ...
        // ok so the IDs match. Does the destination account exist?
            ...
            LogNormal(OT_METHOD)(__func__)(": ERROR verifying "
        ...
        // Are both of the accounts of the same Asset Type?
            ...
            LogOutput(OT_METHOD)(__func__)(
                ...
                " ")(strFromInstrumentDefinitionID)(" ")(strDestinationInstrumentDefinitionID)
                .Flush();
        }
        ...
        // performing the actual transfer.
            ...
            if (true == bSuccessLoadingInbox) {
                ...
                LogOutput(OT_METHOD)(__func__)(": Error loading 'to' inbox.")
                    .Flush();
            }
            ...
            if (true == bSuccessLoadingOutbox) {
                ...
                LogOutput(OT_METHOD)(__func__)(": Error loading 'from' "
                                               "outbox.")
                    .Flush();
            }
    ...
    bool& bOutSuccess)
{
    ...
    if (nullptr == pItem) {
        ...
        LogOutput(OT_METHOD)(__func__)(
            ...
            "#")(tranIn
                     .GetTransactionNum())(": ")(strTemp->Exists() ? strTemp->Get() : "(ERROR LOADING TRANSACTION INTO STRING)")
            .Flush();
    }
    ...
    // This permission has to do with ALL withdrawals (cash or voucher)
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All withdrawals "
                                 "are disallowed in "
                                 "server.cfg")
            .Flush();
    }
    // This permission has to do with vouchers.
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (withdraw "
    ...
    // This permission has to do with cash.
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (withdraw cash "
                                 "is disallowed in "
                                 "server.cfg")
            .Flush();
    }
        ...
        //
            ...
            if (!bLoadContractFromString) {
                ...
                LogOutput(OT_METHOD)(__func__)(
                    ...
                    "(")(theVoucherRequest
                             ->GetTransactionNum())(") in withdrawal "
                                                    "request ")(tranIn
                                                                    .GetTransactionNum())(" for Nym: ")(strNymID
                                                                                                            ->Get())(".")
                    .Flush();
            } else if (
                INSTRUMENT_DEFINITION_ID !=
                ...
                LogOutput(OT_METHOD)(__func__)(
                    ...
                    "(")(strInstrumentDefinitionID
                             ->Get())(") on the withdraw voucher request "
                                      "(found: ")(strFoundInstrumentDefinitionID
                                                      ->Get())(") for "
                                                               "transaction"
                                                               " ")(tranIn
                                                                        .GetTransactionNum())(", voucher ")(theVoucherRequest
                                                                                                                ->GetTransactionNum())(". User: ")(strNymID
                                                                                                                                                       ->Get())(".")
                    .Flush();
    ...
    bool& bOutSuccess)
{
    ...
    // This permission has to do with paying dividends.
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (payDividend is "
                                 "disallowed in "
                                 "server.cfg)")
            .Flush();
    }
    // Check for a balance agreement...
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": Expected Item::balanceStatement, but not found in trans "
            "#")(tranIn
                     .GetTransactionNum())(": ")(strTemp->Exists() ? strTemp->Get() : " (ERROR SERIALIZING TRANSACTION INTO A STRING)")
            .Flush();
    }
                        ...
                        } else  // successfully verified the balance agreement.
                        {
                            ...
                            if ((lTotalCostOfDividend > 0) &&
                                        ...
                                        lTotalCostOfDividend))  // theVoucherRequest->GetAmount()))
                                {
                                    LogOutput(OT_METHOD)(__func__)(
                                        ": Failed "
                                        "crediting ")(lTotalCostOfDividend)(" u"
                                                                            "ni"
                                                                            "ts"
                                                                            " t"
                                                                            "o "
                                    ...
                                    if (lLeftovers > 0) {
                                        ...
                                        LogOutput(OT_METHOD)(__func__)(
                                            ...
                                            "with ")(lTotalCostOfDividend)(" un"
                                                                           ...
                                                                           "wer"
                                                                           "e"
                                                                           " ")(lLeftovers)(" units remaining. (Returning them "
                                                                                            "to sender...)")
                                            .Flush();
                                            ...
                                            if (!bSent) {
                                                ...
                                                LogOutput(OT_METHOD)(__func__)(
                                                    ...
                                                    "PAY ")(lLeftovers)(" of "
                                                                        ...
                                                                        "defini"
                                                                        "tion"
                                                                        " ")(strPayoutInstrumentDefinitionID)(" to Nym ")(strSenderNymID)
                                                    .Flush();
                                            }   // if !bSent
                                        } else  // !bGotNextTransNum
                                        {
                                            ...
                                            LogOutput(OT_METHOD)(__func__)(
                                                ...
                                                "PAY ")(lLeftovers)(" of asset "
                                                                    "type"
                                                                    " ")(strPayoutInstrumentDefinitionID)(" to Nym ")(strRecipientNymID)
                                                .Flush();
                                        }
                                    }
                                }  // else
    ...
    bool& success)
{
    ...
    if (false == bool(balanceItem)) {
        LogOutput(OT_METHOD)(__func__)(
            ": Deposit transaction ")(input.GetTransactionNum())(" does not "
                                                                 "contain a "
                                                                 "balance "
                                                                 "agreement "
                                                                 "item.")
    ...
    switch (type) {
        ...
        default: {
            LogOutput(OT_METHOD)(__func__)(": Invalid deposit item type.")
                .Flush();
    ...
    bool& bOutSuccess)
{
    ...
    if ((nullptr != pItem) &&
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All payment "
            ...
            if ((false == pPlan->LoadContractFromString(strPaymentPlan))) {
                ...
                if (lFoundNum != lExpectedNum) {
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "while ")(bCancelling ? "cancelling" : "activating")(" "
                                                                             ...
                                                                             "n"
                                                                             " "
                                                                             "(")(lFoundNum)("). Expected based on transaction: ")(lExpectedNum)
                        .Flush();
                }
                ...
                if (lFoundOpeningNum != pItem->GetTransactionNum()) {
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "while ")(bCancelling ? "cancelling" : "activating")("p"
                                                                             "a"
                                                                             "y"
                                                                             "m"
                                                                             "e"
                                                                             ...
                                                                             "n"
                                                                             " "
                                                                             "(")(lFoundOpeningNum)("). Expected based on transaction: ")(pItem
                                                                                                                                              ->GetTransactionNum())
                        .Flush();
                    ...
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "(")(strAcctID1)(") "
                                         "while"
                                         " ")(bCancelling ? "cancelling" : "activating")(" payment plan. Expected: ")(strAcctID2)
                        .Flush();
                }
                        ...
                        if (!bCancelling &&
                            ...
                            // VERY IMPORTANT!!
                                ...
                                LogOutput(OT_METHOD)(__func__)(
                                    ...
                                    "to ")(bCancelling ? "cancel" : "activate")(" a payment plan between dissimilar "
                                                                                "instrument definitions: ")(strSourceInstrumentDefinitionID)(", ")(strRecipInstrumentDefinitionID)
                                    .Flush();
                            }
    ...
    bool& bOutSuccess)
{
    ...
    if ((nullptr != pItem) &&
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All smart "
                ...
                if (lFoundNum != lExpectedNum) {
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "number ")(lFoundNum)("on smart contract. "
                                              "Found: ")(lExpectedNum)(" Expect"
                                                                       "ed:"
                                                                       " ")(lExpectedNum)("FYI, pItem->GetTransactionNum() is ")(pItem
                                                                                                                                     ->GetTransactionNum())
                        .Flush();
                    ...
                    LogOutput(OT_METHOD)(__func__)(
                        ":ERROR wrong user ID (")(strWrongID)(") used "
                                                              "while"
                                                              " ")(bCancelling ? "canceling" : "activating")("smart contract. Expected from contract: ")(strRightID)
                        .Flush();
                    ...
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "(")(strActivatorAcctID)(") to ")(bCancelling ? "cancel" : "activate")("smart contract. Expected from contract: ")(strSenderAcctID)
                        .Flush();
                }
                ...
                // Verify that it can still be USED (not closed...)
                {
                    LogOutput(OT_METHOD)(__func__)(
                        ...
                        "number ")(lFoundClosingNum)(" wasn't "
                                                     ...
                                                     "for use "
                                                     "while"
                                                     " ")(bCancelling ? "canceling" : "activating")(" a smart contract.")
                        .Flush();
                }
                ...
                //
                    ...
                    if (false == contract->SendNoticeToAllParties(
                        ...
                        LogOutput(OT_METHOD)(__func__)(
                            ...
                            "activate smart contract: ")(contract
                                                             ->GetTransactionNum())
                            .Flush();
                    }
                    // Add it to Cron...
    ...
    bool& bOutSuccess)
{
    ...
    if (!NYM_IS_ALLOWED(
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (CancelCronItem "
                                 "messages are "
                                 "disallowed in server.cfg)")
            .Flush();
            ...
            } else  // LET'S SEE IF WE CAN REMOVE IT THEN...
            {
                ...
                if (bSuccess) {
                    ...
                    LogDetail(OT_METHOD)(__func__)(
                        ...
                        "based on ID: ")((pCronItem) ? pCronItem->GetTransactionNum() : lReferenceToNum)
                        .Flush();
    ...
    bool& bOutSuccess)
{
    ...
    if (!NYM_IS_ALLOWED(
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All basket "
                                 "exchanges are disallowed "
                                 "in server.cfg)")
            .Flush();
    } else if (nullptr == pItem) {
        LogNormal(OT_METHOD)(__func__)(": No exchangeBasket item found on "
                                       "this transaction.")
            .Flush();
    } else if (nullptr == pBalanceItem) {
        LogNormal(OT_METHOD)(__func__)(
    ...
    bool& bOutSuccess)
{
    ...
    if (!NYM_IS_ALLOWED(
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" cannot do this transaction (All market "
    ...
    // successfully or not.
        ...
        if (!pBalanceItem->VerifyTransactionStatement(context, tranIn)) {
            ...
            // also be a closing number for closing it.
                ...
                LogOutput(OT_METHOD)(__func__)(
                    ": ERROR wrong Nym ID (")(strID1)(") on trade. "
                                                      "Expected: ")(strID2)
                    .Flush();
            } else if (
                ...
                LogOutput(OT_METHOD)(__func__)(": ERROR wrong asset Acct ID "
                                               "(")(strAcctID1)(") on trade. "
                                                                "Expected:"
                                                                " ")(strAcctID2)
                    .Flush();
    ...
    bool& bOutSuccess)
{
    ...
    if (false == bool(pInbox)) {
        LogOutput(OT_METHOD)(__func__)(": Error loading or verifying inbox.")
            .Flush();
        ...
        if (tranIn.GetInboxHash() != inboxHash) {
            LogOutput(OT_METHOD)(__func__)(
                ...
                "hash: ")(inboxHash->str())(" Remote inbox "
    ...
    if (false == bool(pOutbox)) {
        LogOutput(OT_METHOD)(__func__)(": Error loading or verifying outbox.")
            .Flush();
        ...
        if (tranIn.GetOutboxHash() != outboxHash) {
            LogOutput(OT_METHOD)(__func__)(
                ...
                "hash: ")(outboxHash->str())(" Remote outbox "
                                             "hash: ")(tranIn.GetOutboxHash()
                                                           ->str())(".")
                .Flush();
        }
    }
    ...
    if (tranIn.GetAccountHash() != accountHash) {
        LogOutput(OT_METHOD)(__func__)(
            ...
            "hash: ")(accountHash->str())(" Remote account "
                                          "hash: ")(tranIn.GetAccountHash()
                                                        ->str())(".")
            .Flush();
    }
    ...
    if (!theFromAccount.get().VerifyContractID()) {
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": Error verifying account ID:")(strIDAcct)
            .Flush();
    }
    ...
    // transactions on your account, no?
        ...
        LogOutput(OT_METHOD)(__func__)(": Error verifying account ownership... "
                ...
                if ((Item::request == pItem->GetStatus()) &&
                    ...
                    if ((nullptr !=
                        ...
                        LogOutput(OT_METHOD)(__func__)(
                            ...
                            "client is trying to accept: ")(pItem
                                                                ->GetReferenceToNum())
                            .Flush();
                    }
    ...
    bool& bOutSuccess)
{
    ...
    if (false == allowed) {
        LogOutput(OT_METHOD)(__func__)(
            ": User ")(strNymID)(" is not allowed to perform processInbox "
                                 "requests.")
            .Flush();
    ...
    for (const auto& pProcessInboxItem : processInbox.GetItemList()) {
        ...
        switch (item.GetType()) {
            ...
            default: {
                ...
                bSuccessFindingAllTransactions = false;
                LogOutput(OT_METHOD)(__func__)(
                    ":  Wrong item type: ")(strItemType->Exists() ? strItemType->Get() : "")("(")(static_cast<
                                                                                                  std::
                                                                                                      int32_t>(
                    nItemType))(")")
                    .Flush();
        ...
        if (false == bool(pServerTransaction)) {
            ...
            LogOutput(OT_METHOD)(__func__)(
                ...
                "match: ")(pServerTransaction->GetReceiptAmount(
                reason_))(" and ")(item.GetAmount())(". Nym ")(strNymID)
                .Flush();
            bSuccessFindingAllTransactions = false;
            break;
        }
                    ...
                    // outoing original transfer.)
                        ...
                        if (verified) {
                            ...
                            LogOutput(OT_METHOD)(__func__)(
                                ...
                                "issued number (")(pOriginalItem
                                                       ->GetReferenceToNum())(") that already wasn't on Nym's issued list. "
    ...
    if (false == bSuccessFindingAllTransactions) {
        LogOutput(OT_METHOD)(__func__)(": Transactions in processInbox "
    ...
    for (auto& pProcessInboxItem : processInbox.GetItemList()) {
        ...
        switch (pProcessInboxItem->GetType()) {
            ...
            case itemType::disputeBasketReceipt:
                ...
                break;
            default:
                LogOutput(OT_METHOD)(__func__)(": Should never happen.")
                    .Flush();
                theReplyItemType =
            ...
            if (false != bool(pOriginalItem)) {
                ...
                // TRANSFER
                    ...
                    if (true == bSuccessLoadingInbox)
                        ...
                        LogOutput(OT_METHOD)(__func__)(": ERROR missing 'from' "
                                                       "inbox in "
                                                       "Notary::"
                                                       "NotarizeProcessInbox.")
                            .Flush();
        ...
        if (false == proto::Validate(serializedPurse, VERBOSE)) {
            ...
            if (false == bool(pPurse)) {
                ...
                if (false == purse.Unlock(*context.Nym(), reason_)) {
                    LogOutput(OT_METHOD)(__func__)(": Failed to decrypt purse")
                        .Flush();
                } else if (
    ...
    bool& success)
{
    ...
    if (false == bool(pRequestPurse)) {
        ...
        LogInsane(OT_METHOD)(__func__)(": Request purse instantiated").Flush();
    }

    auto& requestPurse = *pRequestPurse;

    if (false == requestPurse.Unlock(*context.Nym(), reason_)) {
        LogOutput(OT_METHOD)(__func__)(": Failed to decrypt purse").Flush();
    ...
    if (false == bool(pReplyPurse)) {
        LogOutput(OT_METHOD)(__func__)(": Failed to instantiate reply purse")
            .Flush();
    ...
    if (false == replyPurse.AddNym(*context.Nym(), reason_)) {
        LogOutput(OT_METHOD)(__func__)(": Failed to encrypt reply purse")
            .Flush();
    ...
    if (false == verifiedBalance) {
        ...
        LogInsane(OT_METHOD)(__func__)(": Balance statement verified").Flush();
    }
    ...
    Item& responseBalanceItem)
{
    ...
    if (accountID != depositItem.GetPurportedAccountID()) {
        LogOutput(OT_METHOD)(__func__)(": Wrong account ID on deposit item.")
            .Flush();
    ...
    const std::shared_ptr<const OTTransaction>& item) const
{
    ...
    if (false == bool(item)) {
        LogOutput(OT_METHOD)(__func__)(": No transaction item.").Flush();
    ...
    if (false == proto::Validate(push, VERBOSE)) {
        LogOutput(OT_METHOD)(__func__)(": Unable to send push notification.")
            .Flush();
    ...
    blind::Token& token) -> bool
{
    ...
    if (false == bool(pMint)) {
        LogOutput(OT_METHOD)(__func__)(": Unable to get or load Mint.").Flush();
    ...
    if (false == depositAccount.Credit(amount)) {
        LogOutput(OT_METHOD)(__func__)(": Error "
                                       "crediting the user's asset "
                                       "account...")
            .Flush();

        if (false == reserveAccount.get().Credit(amount)) {
            LogOutput(OT_METHOD)(__func__)(": Failure crediting-back "
    ...
    if (false == spent) {
        LogOutput(OT_METHOD)(__func__)(": Failed recording token as spent...")
            .Flush();
    ...
    std::shared_ptr<blind::Token> pToken) -> bool
{
    ...
    if (false == bool(pMint)) {
        LogOutput(OT_METHOD)(__func__)(
            ": Unable to find Mint (series ")(series)("): ")(unit)
            .Flush();
    ...
    if (false == signedToken) {
        LogOutput(OT_METHOD)(__func__)(": Failed to sign token").Flush();
    ...
    if (false == replyPurse.Push(pToken, reason_)) {
        LogOutput(OT_METHOD)(__func__)(": Failed to push token to reply purse")
            .Flush();
    ...
    if (account.Debit(value)) {
        ...
        LogOutput(OT_METHOD)(__func__)(
            ": Unable to debit account ")(account
                                              .GetPurportedAccountID())(" in "
                                                                        "the "
                                                                        "amount"
                                                                        " of:"
                                                                        " ")(value)
...
auto Notary::verify_token(blind::Mint& mint, blind::Token& token) -> bool
{
    ...
    if (false == mint.VerifyToken(server_.GetServerNym(), token, reason_)) {
        LogOutput(OT_METHOD)(__func__)(": Failed to verofy token").Flush();
    ...
    if (spent) {
        LogOutput(OT_METHOD)(__func__)(": Token is already spent").Flush();
