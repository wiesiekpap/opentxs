    ...
    , m_strGroupName(String::Factory())
{
    ...
    if (!bNymRepresentsSelf) {
        ...
        //
        LogError()(OT_PRETTY_CLASS(__func__))("THIS HASN'T BEEN WRITTEN YET!!")
            .Flush();
    }
}
...
auto OTAgent::VerifySignature(const Contract& theContract) const -> bool
{
    ...
    if (!IsAnIndividual() || !DoesRepresentHimself()) {
        LogError()(OT_PRETTY_CLASS(__func__))(
            "Entities and roles are not yet "
...
auto OTAgent::GetCountAuthorizedAccts() -> std::int32_t
{
    if (nullptr == m_pForParty) {
        LogError()(OT_PRETTY_CLASS(__func__))("Error: m_pForParty was "
                                              "nullptr.")
            .Flush();
...
auto OTAgent::VerifyAgencyOfAccount(const Account& theAccount) const -> bool
{
    ...
    if (!GetSignerID(theSignerID)) {
        LogError()(OT_PRETTY_CLASS(__func__))("ERROR: Entities and roles "
    ...
    const String& strNotaryID) -> bool
{
    ...
    if (nullptr != m_pNym) {
        ...
        LogError()(OT_PRETTY_CLASS(__func__))("Error: m_pNym was nullptr. For "
                                              "agent: ")(m_strName)(".")
            .Flush();
    }
    ...
    const String& strNotaryID) -> bool
{
    ...
    if (nullptr != m_pNym) {
        ...
        LogError()(OT_PRETTY_CLASS(__func__))("Error: m_pNym was nullptr. "
                                              "For agent: ")(m_strName)(".")
            .Flush();
    }
    ...
    otx::context::Base& context) -> bool
{
    ...
    if (nullptr != m_pNym) {
        ...
        if (bSuccess) {
            ...
            LogError()(OT_PRETTY_CLASS(__func__))("Number (")(
