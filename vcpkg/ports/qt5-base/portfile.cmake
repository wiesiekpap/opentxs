...
qt_download_submodule(  OUT_SOURCE_PATH SOURCE_PATH
                        PATCHES
                            ...
                            # We really want to statically link angle on Windows.  See also lines 131, 264.
...
list(APPEND CORE_OPTIONS
    ...
    -icu
    -no-vulkan
    # We want Qt to build and statically link angle.  See also lines 84, 266.
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    # We want angle statically linked on Windows.  See also lines 84, 131.
        list(APPEND CORE_OPTIONS -opengl es2 -angle) # other possible option without moving angle dlls: "-opengl desktop". "-opengel es2" only works with commented patch
    endif()
